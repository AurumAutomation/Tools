...
Paulo Rossi
prossi@aurumautomation.ca
©2024 Aurum Automation Inc.
Open-Sourced per GNU GPL v3

You should have received a copy of the GNU General Public License along with this program.  If not, see &lt;https://www.gnu.org/licenses/&gt;.</Property>
	...
	<Item Name="DMM_Concrete.lvclass" Type="LVClass" URL="../DMM/DMM_Concrete.lvclass"/>
	<Item Name="Switch_Concrete.lvclass" Type="LVClass" URL="../Switch_Concrete/Switch_Concrete.lvclass"/>
	<Item Name="DAQ.lvclass" Type="LVClass" URL="../DAQ/DAQ.lvclass"/>
	<Item Name="PSU.lvclass" Type="LVClass" URL="../PSU/PSU.lvclass"/>
	<Item Name="Keithley_PSU.lvclass" Type="LVClass" URL="../Keysight_PSU/Keithley_PSU.lvclass"/>
	<Item Name="NI_PSU.lvclass" Type="LVClass" URL="../NI_PSU/NI_PSU.lvclass"/>
</Library>
